...
object Parser {
  ...
  def forEachChild[T](node: Node,
                      cbNode: ((Node) => T),
                      cbNodeArray: ((Array[Node]) => T)): T = {
    if ((!node)) {
      return

    }
    val visitNodes: (((((Node | Array[Node])) => T), Array[Node]) => T) =
      (if (cbNodeArray) visitNodeArray else visitEachNode)
    val cbNodes = (cbNodeArray || cbNode)
    node.kind match {
      case SyntaxKind.QualifiedName =>
        return (visitNode(cbNode, (node.asInstanceOf[QualifiedName]).left) || visitNode(
          cbNode,
          (node.asInstanceOf[QualifiedName]).right))
      case SyntaxKind.TypeParameter =>
        return ((visitNode(
          cbNode,
          (node.asInstanceOf[TypeParameterDeclaration]).name) || visitNode(
          cbNode,
          (node
            .asInstanceOf[TypeParameterDeclaration])
            .constraint)) || visitNode(
          cbNode,
          (node.asInstanceOf[TypeParameterDeclaration]).expression))
      case SyntaxKind.ShorthandPropertyAssignment =>
        return (((((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ShorthandPropertyAssignment]).name)) || visitNode(
          cbNode,
          (node
          ...
          (node
            .asInstanceOf[ShorthandPropertyAssignment])
            .equalsToken)) || visitNode(
          cbNode,
          (node
            .asInstanceOf[ShorthandPropertyAssignment])
            .objectAssignmentInitializer))
      case SyntaxKind.Parameter | SyntaxKind.PropertyDeclaration |
          SyntaxKind.PropertySignature | SyntaxKind.PropertyAssignment |
        ...
        return (((((((visitNodes(cbNodes, node.decorators) || visitNodes(
          ...
          (node
            ...
            .propertyName)) || visitNode(
          cbNode,
          (node
            .asInstanceOf[VariableLikeDeclaration])
            .dotDotDotToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[VariableLikeDeclaration]).name)) || visitNode(
          cbNode,
          (node
            .asInstanceOf[VariableLikeDeclaration])
            .questionToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[VariableLikeDeclaration]).`type`)) || visitNode(
          cbNode,
          (node.asInstanceOf[VariableLikeDeclaration]).initializer))
      case SyntaxKind.FunctionType | SyntaxKind.ConstructorType |
          SyntaxKind.CallSignature | SyntaxKind.ConstructSignature |
          SyntaxKind.IndexSignature =>
        return ((((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNodes(
          cbNodes,
          (node
            .asInstanceOf[SignatureDeclaration])
            .typeParameters)) || visitNodes(
          cbNodes,
          (node.asInstanceOf[SignatureDeclaration]).parameters)) || visitNode(
          cbNode,
          (node.asInstanceOf[SignatureDeclaration]).`type`))
      case SyntaxKind.MethodDeclaration | SyntaxKind.MethodSignature |
        ...
        return (((((((((visitNodes(cbNodes, node.decorators) || visitNodes(
          ...
          (node
            ...
            .asteriskToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[FunctionLikeDeclaration]).name)) || visitNode(
          cbNode,
          (node
            .asInstanceOf[FunctionLikeDeclaration])
            .questionToken)) || visitNodes(
          cbNodes,
          (node
            .asInstanceOf[FunctionLikeDeclaration])
            .typeParameters)) || visitNodes(
          ...
          (node
            .asInstanceOf[FunctionLikeDeclaration])
            .parameters)) || visitNode(
          cbNode,
          (node.asInstanceOf[FunctionLikeDeclaration]).`type`)) || visitNode(
          cbNode,
          (node
            .asInstanceOf[ArrowFunction])
            .equalsGreaterThanToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[FunctionLikeDeclaration]).body))
      case SyntaxKind.TypeReference =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[TypeReferenceNode]).typeName) || visitNodes(
          cbNodes,
          (node.asInstanceOf[TypeReferenceNode]).typeArguments))
      case SyntaxKind.TypePredicate =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[TypePredicateNode]).parameterName) || visitNode(
          cbNode,
          (node.asInstanceOf[TypePredicateNode]).`type`))
      case SyntaxKind.TypeQuery =>
        return visitNode(cbNode, (node.asInstanceOf[TypeQueryNode]).exprName)
      case SyntaxKind.TypeLiteral =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[TypeLiteralNode]).members)
      ...
      case SyntaxKind.TupleType =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[TupleTypeNode]).elementTypes)
      case SyntaxKind.UnionType | SyntaxKind.IntersectionType =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[UnionOrIntersectionTypeNode]).types)
      ...
      case SyntaxKind.ObjectBindingPattern | SyntaxKind.ArrayBindingPattern =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[BindingPattern]).elements)
      ...
      case SyntaxKind.PropertyAccessExpression =>
        return (visitNode(
          ...
          cbNode,
          (node.asInstanceOf[PropertyAccessExpression]).name))
      case SyntaxKind.ElementAccessExpression =>
        return (visitNode(
          ...
          (node
            ...
            .expression) || visitNode(
          cbNode,
          (node.asInstanceOf[ElementAccessExpression]).argumentExpression))
      case SyntaxKind.CallExpression | SyntaxKind.NewExpression =>
        return ((visitNode(
          cbNode,
          (node.asInstanceOf[CallExpression]).expression) || visitNodes(
          cbNodes,
          (node.asInstanceOf[CallExpression]).typeArguments)) || visitNodes(
          cbNodes,
          (node.asInstanceOf[CallExpression]).arguments))
      case SyntaxKind.TaggedTemplateExpression =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[TaggedTemplateExpression]).tag) || visitNode(
          cbNode,
          (node.asInstanceOf[TaggedTemplateExpression]).template))
      case SyntaxKind.TypeAssertionExpression =>
        return (visitNode(cbNode, (node.asInstanceOf[TypeAssertion]).`type`) || visitNode(
          cbNode,
          (node.asInstanceOf[TypeAssertion]).expression))
      ...
      case SyntaxKind.DeleteExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[DeleteExpression]).expression)
      case SyntaxKind.TypeOfExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[TypeOfExpression]).expression)
      case SyntaxKind.VoidExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[VoidExpression]).expression)
      case SyntaxKind.PrefixUnaryExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[PrefixUnaryExpression]).operand)
      case SyntaxKind.YieldExpression =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[YieldExpression]).asteriskToken) || visitNode(
          cbNode,
          (node.asInstanceOf[YieldExpression]).expression))
      case SyntaxKind.AwaitExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[AwaitExpression]).expression)
      case SyntaxKind.PostfixUnaryExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[PostfixUnaryExpression]).operand)
      case SyntaxKind.BinaryExpression =>
        return ((visitNode(cbNode, (node.asInstanceOf[BinaryExpression]).left) || visitNode(
          cbNode,
          (node.asInstanceOf[BinaryExpression]).operatorToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[BinaryExpression]).right))
      case SyntaxKind.AsExpression =>
        return (visitNode(cbNode, (node.asInstanceOf[AsExpression]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[AsExpression]).`type`))
      case SyntaxKind.NonNullExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[NonNullExpression]).expression)
      case SyntaxKind.ConditionalExpression =>
        return ((((visitNode(
          cbNode,
          (node.asInstanceOf[ConditionalExpression]).condition) || visitNode(
          cbNode,
          (node
            .asInstanceOf[ConditionalExpression])
            .questionToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[ConditionalExpression]).whenTrue)) || visitNode(
          cbNode,
          (node.asInstanceOf[ConditionalExpression]).colonToken)) || visitNode(
          cbNode,
          (node.asInstanceOf[ConditionalExpression]).whenFalse))
      case SyntaxKind.SpreadElementExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[SpreadElementExpression]).expression)
      case SyntaxKind.Block | SyntaxKind.ModuleBlock =>
        return visitNodes(cbNodes, (node.asInstanceOf[Block]).statements)
      case SyntaxKind.SourceFile =>
        return (visitNodes(cbNodes, (node.asInstanceOf[SourceFile]).statements) || visitNode(
          cbNode,
          (node.asInstanceOf[SourceFile]).endOfFileToken))
      case SyntaxKind.VariableStatement =>
        return ((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[VariableStatement]).declarationList))
      case SyntaxKind.VariableDeclarationList =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[VariableDeclarationList]).declarations)
      case SyntaxKind.ExpressionStatement =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[ExpressionStatement]).expression)
      case SyntaxKind.IfStatement =>
        return ((visitNode(cbNode, (node.asInstanceOf[IfStatement]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[IfStatement]).thenStatement)) || visitNode(
          cbNode,
          (node.asInstanceOf[IfStatement]).elseStatement))
      case SyntaxKind.DoStatement =>
        return (visitNode(cbNode, (node.asInstanceOf[DoStatement]).statement) || visitNode(
          cbNode,
          (node.asInstanceOf[DoStatement]).expression))
      case SyntaxKind.WhileStatement =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[WhileStatement]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[WhileStatement]).statement))
      case SyntaxKind.ForStatement =>
        return (((visitNode(
          cbNode,
          (node.asInstanceOf[ForStatement]).initializer) || visitNode(
          cbNode,
          (node.asInstanceOf[ForStatement]).condition)) || visitNode(
          cbNode,
          (node.asInstanceOf[ForStatement]).incrementor)) || visitNode(
          cbNode,
          (node.asInstanceOf[ForStatement]).statement))
      case SyntaxKind.ForInStatement =>
        return ((visitNode(
          cbNode,
          (node.asInstanceOf[ForInStatement]).initializer) || visitNode(
          cbNode,
          (node.asInstanceOf[ForInStatement]).expression)) || visitNode(
          cbNode,
          (node.asInstanceOf[ForInStatement]).statement))
      case SyntaxKind.ForOfStatement =>
        return ((visitNode(
          cbNode,
          (node.asInstanceOf[ForOfStatement]).initializer) || visitNode(
          cbNode,
          (node.asInstanceOf[ForOfStatement]).expression)) || visitNode(
          cbNode,
          (node.asInstanceOf[ForOfStatement]).statement))
      case SyntaxKind.ContinueStatement | SyntaxKind.BreakStatement =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[BreakOrContinueStatement]).label)
      case SyntaxKind.ReturnStatement =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[ReturnStatement]).expression)
      case SyntaxKind.WithStatement =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[WithStatement]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[WithStatement]).statement))
      case SyntaxKind.SwitchStatement =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[SwitchStatement]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[SwitchStatement]).caseBlock))
      case SyntaxKind.CaseBlock =>
        return visitNodes(cbNodes, (node.asInstanceOf[CaseBlock]).clauses)
      case SyntaxKind.CaseClause =>
        return (visitNode(cbNode, (node.asInstanceOf[CaseClause]).expression) || visitNodes(
          cbNodes,
          (node.asInstanceOf[CaseClause]).statements))
      case SyntaxKind.DefaultClause =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[DefaultClause]).statements)
      case SyntaxKind.LabeledStatement =>
        return (visitNode(cbNode, (node.asInstanceOf[LabeledStatement]).label) || visitNode(
          cbNode,
          (node.asInstanceOf[LabeledStatement]).statement))
      case SyntaxKind.ThrowStatement =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[ThrowStatement]).expression)
      case SyntaxKind.TryStatement =>
        return ((visitNode(cbNode, (node.asInstanceOf[TryStatement]).tryBlock) || visitNode(
          cbNode,
          (node.asInstanceOf[TryStatement]).catchClause)) || visitNode(
          cbNode,
          (node.asInstanceOf[TryStatement]).finallyBlock))
      case SyntaxKind.CatchClause =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[CatchClause]).variableDeclaration) || visitNode(
          cbNode,
          (node.asInstanceOf[CatchClause]).block))
      ...
      case SyntaxKind.ClassDeclaration | SyntaxKind.ClassExpression =>
        return (((((visitNodes(cbNodes, node.decorators) || visitNodes(
          ...
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ClassLikeDeclaration]).name)) || visitNodes(
          cbNodes,
          (node
            .asInstanceOf[ClassLikeDeclaration])
            .typeParameters)) || visitNodes(
          cbNodes,
          (node
            .asInstanceOf[ClassLikeDeclaration])
            .heritageClauses)) || visitNodes(
          cbNodes,
          (node.asInstanceOf[ClassLikeDeclaration]).members))
      case SyntaxKind.InterfaceDeclaration =>
        return (((((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[InterfaceDeclaration]).name)) || visitNodes(
          cbNodes,
          (node
          ...
          (node
            ...
            .heritageClauses)) || visitNodes(
          cbNodes,
          (node.asInstanceOf[InterfaceDeclaration]).members))
      case SyntaxKind.TypeAliasDeclaration =>
        return ((((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[TypeAliasDeclaration]).name)) || visitNodes(
          cbNodes,
          (node
            .asInstanceOf[TypeAliasDeclaration])
            .typeParameters)) || visitNode(
          cbNode,
          (node.asInstanceOf[TypeAliasDeclaration]).`type`))
      case SyntaxKind.EnumDeclaration =>
        return (((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[EnumDeclaration]).name)) || visitNodes(
          cbNodes,
          (node.asInstanceOf[EnumDeclaration]).members))
      case SyntaxKind.EnumMember =>
        return (visitNode(cbNode, (node.asInstanceOf[EnumMember]).name) || visitNode(
          cbNode,
          (node.asInstanceOf[EnumMember]).initializer))
      case SyntaxKind.ModuleDeclaration =>
        return (((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ModuleDeclaration]).name)) || visitNode(
          cbNode,
          (node.asInstanceOf[ModuleDeclaration]).body))
      case SyntaxKind.ImportEqualsDeclaration =>
        return (((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportEqualsDeclaration]).name)) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportEqualsDeclaration]).moduleReference))
      case SyntaxKind.ImportDeclaration =>
        return (((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportDeclaration]).importClause)) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportDeclaration]).moduleSpecifier))
      case SyntaxKind.ImportClause =>
        return (visitNode(cbNode, (node.asInstanceOf[ImportClause]).name) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportClause]).namedBindings))
      case SyntaxKind.NamespaceExportDeclaration =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[NamespaceExportDeclaration]).name)
      case SyntaxKind.NamespaceImport =>
        return visitNode(cbNode, (node.asInstanceOf[NamespaceImport]).name)
      case SyntaxKind.NamedImports | SyntaxKind.NamedExports =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[NamedImportsOrExports]).elements)
      case SyntaxKind.ExportDeclaration =>
        return (((visitNodes(cbNodes, node.decorators) || visitNodes(
          cbNodes,
          node.modifiers)) || visitNode(
          cbNode,
          (node.asInstanceOf[ExportDeclaration]).exportClause)) || visitNode(
          cbNode,
      ...
      case SyntaxKind.ImportSpecifier | SyntaxKind.ExportSpecifier =>
        return (visitNode(
          cbNode,
          (node
            .asInstanceOf[ImportOrExportSpecifier])
            .propertyName) || visitNode(
          cbNode,
          (node.asInstanceOf[ImportOrExportSpecifier]).name))
      ...
      case SyntaxKind.TemplateExpression =>
        return (visitNode(cbNode, (node.asInstanceOf[TemplateExpression]).head) || visitNodes(
          cbNodes,
          (node.asInstanceOf[TemplateExpression]).templateSpans))
      case SyntaxKind.TemplateSpan =>
        return (visitNode(cbNode, (node.asInstanceOf[TemplateSpan]).expression) || visitNode(
          cbNode,
          (node.asInstanceOf[TemplateSpan]).literal))
      case SyntaxKind.ComputedPropertyName =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[ComputedPropertyName]).expression)
      ...
      case SyntaxKind.ExpressionWithTypeArguments =>
        return (visitNode(
          ...
          (node
            ...
            .expression) || visitNodes(
          cbNodes,
          (node.asInstanceOf[ExpressionWithTypeArguments]).typeArguments))
      case SyntaxKind.ExternalModuleReference =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[ExternalModuleReference]).expression)
      case SyntaxKind.MissingDeclaration =>
        return visitNodes(cbNodes, node.decorators)
      case SyntaxKind.JsxElement =>
        return ((visitNode(
          cbNode,
          (node.asInstanceOf[JsxElement]).openingElement) || visitNodes(
          cbNodes,
          (node.asInstanceOf[JsxElement]).children)) || visitNode(
          cbNode,
          (node.asInstanceOf[JsxElement]).closingElement))
      case SyntaxKind.JsxSelfClosingElement | SyntaxKind.JsxOpeningElement =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[JsxOpeningLikeElement]).tagName) || visitNodes(
          cbNodes,
          (node.asInstanceOf[JsxOpeningLikeElement]).attributes))
      case SyntaxKind.JsxAttribute =>
        return (visitNode(cbNode, (node.asInstanceOf[JsxAttribute]).name) || visitNode(
          cbNode,
          (node.asInstanceOf[JsxAttribute]).initializer))
      case SyntaxKind.JsxSpreadAttribute =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JsxSpreadAttribute]).expression)
      case SyntaxKind.JsxExpression =>
        return visitNode(cbNode, (node.asInstanceOf[JsxExpression]).expression)
      case SyntaxKind.JsxClosingElement =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JsxClosingElement]).tagName)
      case SyntaxKind.JSDocTypeExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypeExpression]).`type`)
      ...
      case SyntaxKind.JSDocArrayType =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocArrayType]).elementType)
      case SyntaxKind.JSDocNonNullableType =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocNonNullableType]).`type`)
      ...
      case SyntaxKind.JSDocTypeReference =>
        return (visitNode(cbNode, (node.asInstanceOf[JSDocTypeReference]).name) || visitNodes(
          cbNodes,
          (node.asInstanceOf[JSDocTypeReference]).typeArguments))
      case SyntaxKind.JSDocOptionalType =>
        return visitNode(cbNode, (node.asInstanceOf[JSDocOptionalType]).`type`)
      case SyntaxKind.JSDocFunctionType =>
        return (visitNodes(
          cbNodes,
          (node.asInstanceOf[JSDocFunctionType]).parameters) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocFunctionType]).`type`))
      case SyntaxKind.JSDocVariadicType =>
        return visitNode(cbNode, (node.asInstanceOf[JSDocVariadicType]).`type`)
      case SyntaxKind.JSDocConstructorType =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocConstructorType]).`type`)
      case SyntaxKind.JSDocThisType =>
        return visitNode(cbNode, (node.asInstanceOf[JSDocThisType]).`type`)
      case SyntaxKind.JSDocRecordMember =>
        return (visitNode(cbNode, (node.asInstanceOf[JSDocRecordMember]).name) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocRecordMember]).`type`))
      ...
      case SyntaxKind.JSDocParameterTag =>
        return ((visitNode(
          cbNode,
          (node
            .asInstanceOf[JSDocParameterTag])
            .preParameterName) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocParameterTag]).typeExpression)) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocParameterTag]).postParameterName))
      case SyntaxKind.JSDocReturnTag =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocReturnTag]).typeExpression)
      case SyntaxKind.JSDocTypeTag =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypeTag]).typeExpression)
      case SyntaxKind.JSDocTemplateTag =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[JSDocTemplateTag]).typeParameters)
      case SyntaxKind.JSDocTypedefTag =>
        return (((visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypedefTag]).typeExpression) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypedefTag]).fullName)) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypedefTag]).name)) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocTypedefTag]).jsDocTypeLiteral))
      case SyntaxKind.JSDocTypeLiteral =>
        return visitNodes(
          cbNodes,
          (node.asInstanceOf[JSDocTypeLiteral]).jsDocPropertyTags)
      case SyntaxKind.JSDocPropertyTag =>
        return (visitNode(
          cbNode,
          (node.asInstanceOf[JSDocPropertyTag]).typeExpression) || visitNode(
          cbNode,
          (node.asInstanceOf[JSDocPropertyTag]).name))
      case SyntaxKind.PartiallyEmittedExpression =>
        return visitNode(
          cbNode,
          (node.asInstanceOf[PartiallyEmittedExpression]).expression)
  ...
  def updateSourceFile(sourceFile: SourceFile,
                       newText: String,
  ...
  def parseIsolatedJSDocComment(content: String, start: Int, length: Int) = {
    val result =
      Parser.JSDocParser.parseIsolatedJSDocComment(content, start, length)
  ...
  def parseJSDocTypeExpressionForTests(content: String,
                                       start: Int,
                                       length: Int) = {
    return Parser.JSDocParser
      .parseJSDocTypeExpressionForTests(content, start, length)
  ...
  object Parser {
    ...
    def parseSourceFile(fileName: String,
                        sourceText: String,
                        languageVersion: ScriptTarget,
      ...
      val result = parseSourceFileWorker(
        fileName,
        languageVersion,
        setParentNodes,
        scriptKind)
    ...
    def getLanguageVariant(scriptKind: ScriptKind) = {
      return (if ((((scriptKind === ScriptKind.TSX) || (scriptKind === ScriptKind.JSX)) || (scriptKind === ScriptKind.JS)))
                LanguageVariant.JSX
              else LanguageVariant.Standard)

    }
    def initializeState(_sourceText: String,
                        languageVersion: ScriptTarget,
                        _syntaxCursor: IncrementalParser.SyntaxCursor,
      ...
      (nodeCount = 0)
      (contextFlags =
        (if (((scriptKind === ScriptKind.JS) || (scriptKind === ScriptKind.JSX)))
    ...
    def parseSourceFileWorker(fileName: String,
                              languageVersion: ScriptTarget,
                              setParentNodes: Boolean,
                              scriptKind: ScriptKind): SourceFile = {
      ...
      (sourceFile.statements =
        parseList(ParsingContext.SourceElements, parseStatement))
      Debug.assert((token() === SyntaxKind.EndOfFileToken))
      (sourceFile.endOfFileToken =
        parseTokenNode().asInstanceOf[EndOfFileToken])
    ...
    def addJSDocComment[T <: Node](node: T): T = {
      ...
      if (comments) {
        (comments).foreach { fresh2 =>
          val comment = zeroOfMyType = fresh2 {
            val jsDoc = JSDocParser.parseJSDocComment(
              node,
              comment.pos,
        ...
        if ((n.parent !== parent)) {
          ...
          if (n.jsDocComments) {
            (n.jsDocComments).foreach { fresh3 =>
              val jsDocComment = zeroOfMyType = fresh3 {
    ...
    def createSourceFile(fileName: String,
                         ...
                         scriptKind: ScriptKind): SourceFile = {
      val sourceFile =
        new SourceFileConstructor(SyntaxKind.SourceFile, 0, sourceText.length)
      ...
      (sourceFile.isDeclarationFile =
        fileExtensionIs(sourceFile.fileName, ".d.ts"))
    ...
    def parseErrorAtPosition(start: Int,
                             length: Int,
    ...
    def speculationHelper[T](callback: (() => T), isLookAhead: Boolean): T = {
      ...
      val saveParseErrorBeforeNextFinishedNode =
        parseErrorBeforeNextFinishedNode
      val saveContextFlags = contextFlags
      val result =
        (if (isLookAhead) scanner.lookAhead(callback)
         else scanner.tryScan(callback))
    ...
    def parseExpected(kind: SyntaxKind,
                      diagnosticMessage: DiagnosticMessage,
                      shouldAdvance: Nothing = true): Boolean = {
      if ((token() === kind)) {
        if (shouldAdvance) {
          nextToken()
    ...
    def parseExpectedToken[TKind <: SyntaxKind](
        t: TKind,
        reportAtCurrentPosition: Boolean,
        diagnosticMessage: DiagnosticMessage,
        arg0: Any): Token[TKind]
    def parseExpectedToken(t: SyntaxKind,
                           reportAtCurrentPosition: Boolean,
                           diagnosticMessage: DiagnosticMessage,
                           arg0: Any): Node = {
    ...
    def canParseSemicolon() = {
      ...
      return (((token() === SyntaxKind.CloseBraceToken) || (token() === SyntaxKind.EndOfFileToken)) || scanner
    ...
    def createNode[TKind <: SyntaxKind](
        kind: TKind,
        pos: Int): (Node | Token[TKind] | Identifier) = {
      (nodeCount += 1)
      if ((!((pos >= 0)))) {
        (pos = scanner.getStartPos())

      }
      return (if ((kind >= SyntaxKind.FirstNode))
                new NodeConstructor(kind, pos, pos)
              else
                (if ((kind === SyntaxKind.Identifier))
                   new IdentifierConstructor(kind, pos, pos)
                 else new TokenConstructor(kind, pos, pos)))
    ...
    def createMissingNode(kind: SyntaxKind,
                          reportAtCurrentPosition: Boolean,
                          diagnosticMessage: DiagnosticMessage,
                          arg0: Any): Node = {
    ...
    def createIdentifier(isIdentifier: Boolean,
                         diagnosticMessage: DiagnosticMessage): Identifier = {
      (identifierCount += 1)
      if (isIdentifier) {
    ...
    def parsePropertyNameWorker(
        allowComputedPropertyNames: Boolean): PropertyName = {
    ...
    def isSimplePropertyName() = {
      return (((token() === SyntaxKind.StringLiteral) || (token() === SyntaxKind.NumericLiteral)) || tokenIsIdentifierOrKeyword(
        token()))

    }
    def parseComputedPropertyName(): ComputedPropertyName = {
      val node = createNode(SyntaxKind.ComputedPropertyName)
    ...
    def nextTokenIsClassOrFunctionOrAsync(): Boolean = {
      nextToken()
      return (((token() === SyntaxKind.ClassKeyword) || (token() === SyntaxKind.FunctionKeyword)) || (((token() === SyntaxKind.AsyncKeyword) && lookAhead(
        nextTokenIsFunctionKeywordOnSameLine))))

    }
    def isListElement(parsingContext: ParsingContext,
                      inErrorRecovery: Boolean): Boolean = {
      ...
      parsingContext match {
        case ParsingContext.SourceElements | ParsingContext.BlockStatements |
        ...
        case ParsingContext.JSDocFunctionParameters |
            ParsingContext.JSDocTypeArguments |
            ParsingContext.JSDocTupleTypes =>
    ...
    def isListTerminator(kind: ParsingContext): Boolean = {
      ...
      kind match {
        case ParsingContext.BlockStatements | ParsingContext.SwitchClauses |
            ParsingContext.TypeMembers | ParsingContext.ClassMembers |
    ...
    def parseList[T <: Node](kind: ParsingContext,
    ...
    def parseListElement[T <: Node](parsingContext: ParsingContext,
                                    parseElement: (() => T)): T = {
      val node = currentNode(parsingContext)
      if (node) {
    ...
    def isReusableClassMember(node: Node) = {
      if (node) {
        node.kind match {
          case SyntaxKind.Constructor | SyntaxKind.IndexSignature |
          ...
          case SyntaxKind.MethodDeclaration =>
            ...
            var nameIsConstructor = ((methodDeclaration.name.kind === SyntaxKind.Identifier) && ((methodDeclaration.name
                .asInstanceOf[Identifier])
                .originalKeywordKind === SyntaxKind.ConstructorKeyword))
    ...
    def isReusableStatement(node: Node) = {
      if (node) {
        node.kind match {
          case SyntaxKind.FunctionDeclaration | SyntaxKind.VariableStatement |
              SyntaxKind.Block | SyntaxKind.IfStatement |
              SyntaxKind.ExpressionStatement | SyntaxKind.ThrowStatement |
              SyntaxKind.ReturnStatement | SyntaxKind.SwitchStatement |
              SyntaxKind.BreakStatement | SyntaxKind.ContinueStatement |
              SyntaxKind.ForInStatement | SyntaxKind.ForOfStatement |
              SyntaxKind.ForStatement | SyntaxKind.WhileStatement |
              SyntaxKind.WithStatement | SyntaxKind.EmptyStatement |
              SyntaxKind.TryStatement | SyntaxKind.LabeledStatement |
              SyntaxKind.DoStatement | SyntaxKind.DebuggerStatement |
              SyntaxKind.ImportDeclaration |
              SyntaxKind.ImportEqualsDeclaration |
              SyntaxKind.ExportDeclaration | SyntaxKind.ExportAssignment |
              SyntaxKind.ModuleDeclaration | SyntaxKind.ClassDeclaration |
    ...
    def isReusableTypeMember(node: Node) = {
      if (node) {
        node.kind match {
          case SyntaxKind.ConstructSignature | SyntaxKind.MethodSignature |
              SyntaxKind.IndexSignature | SyntaxKind.PropertySignature |
    ...
    def parseDelimitedList[T <: Node](
        kind: ParsingContext,
        parseElement: (() => T),
        considerSemicolonAsDelimiter: Boolean): NodeArray[T] = {
      val saveParsingContext = parsingContext
      (parsingContext |= (1 << kind))
      val result = createNodeArray[T]()
      var commaStart = (-1)
      while (true) {
        {
          if (isListElement(kind, false)) {
            ...
            if (((considerSemicolonAsDelimiter && (token() === SyntaxKind.SemicolonToken)) && (!scanner
                  .hasPrecedingLineBreak()))) {
              nextToken()
    ...
    def parseBracketedList[T <: Node](kind: ParsingContext,
                                      parseElement: (() => T),
                                      open: SyntaxKind,
    ...
    def parseEntityName(allowReservedWords: Boolean,
                        diagnosticMessage: DiagnosticMessage): EntityName = {
      var entity: EntityName = parseIdentifier(diagnosticMessage)
      while (parseOptional(SyntaxKind.DotToken)) {
        {
          val node: QualifiedName =
            createNode(SyntaxKind.QualifiedName, entity.pos)
    ...
    def parseRightSideOfDot(allowIdentifierNames: Boolean): Identifier = {
      if ((scanner.hasPrecedingLineBreak() && tokenIsIdentifierOrKeyword(
            token()))) {
        val matchesPattern = lookAhead(
          nextTokenIsIdentifierOrKeywordOnSameLine)
        if (matchesPattern) {
          return createMissingNode(
            SyntaxKind.Identifier,
            true,
            Diagnostics.Identifier_expected).asInstanceOf[Identifier]

        }

      }
      return (if (allowIdentifierNames) parseIdentifierName()
              else parseIdentifier())

    }
    def parseTemplateExpression(): TemplateExpression = {
      val template = createNode(SyntaxKind.TemplateExpression)
    ...
    def parseTemplateSpan(): TemplateSpan = {
      ...
      if ((token() === SyntaxKind.CloseBraceToken)) {
        ...
        (literal = parseExpectedToken(
          SyntaxKind.TemplateTail,
          false,
          Diagnostics._0_expected,
          tokenToString(SyntaxKind.CloseBraceToken))
          .asInstanceOf[TemplateTail])
    ...
    def parseTemplateMiddleOrTemplateTail()
    ...
    def parseLiteralLikeNode(kind: SyntaxKind,
                             internName: Boolean): LiteralLikeNode = {
      ...
      nextToken()
      finishNode(node)
      if ((((node.kind === SyntaxKind.NumericLiteral) && (sourceText
            .charCodeAt(tokenPos) === CharacterCodes._0)) && isOctalDigit(
            sourceText.charCodeAt((tokenPos + 1))))) {
    ...
    def parseTypeReference(): TypeReferenceNode = {
      ...
      val node = createNode(SyntaxKind.TypeReference, typeName.pos)
        .asInstanceOf[TypeReferenceNode]
      (node.typeName = typeName)
      if (((!scanner
            .hasPrecedingLineBreak()) && (token() === SyntaxKind.LessThanToken))) {
    ...
    def parseThisTypePredicate(lhs: ThisTypeNode): TypePredicateNode = {
      nextToken()
      val node = createNode(SyntaxKind.TypePredicate, lhs.pos)
        .asInstanceOf[TypePredicateNode]
    ...
    def parseTypeParameter(): TypeParameterDeclaration = {
      val node = createNode(SyntaxKind.TypeParameter)
        .asInstanceOf[TypeParameterDeclaration]
    ...
    def isStartOfParameter(): Boolean = {
      return (((((token() === SyntaxKind.DotDotDotToken) || isIdentifierOrPattern()) || isModifierKind(
        token())) || (token() === SyntaxKind.AtToken)) || (token() === SyntaxKind.ThisKeyword))

    }
    def parseParameter(): ParameterDeclaration = {
      val node = createNode(SyntaxKind.Parameter)
      ...
      if ((((getFullWidth(node.name) === 0) && (!hasModifiers(node))) && isModifierKind(
            token()))) {
        nextToken()
    ...
    def parseBindingElementInitializer(inParameter: Boolean) = {
      return (if (inParameter) parseParameterInitializer()
              else parseNonParameterInitializer())
    ...
    def fillSignature(returnToken: SyntaxKind,
      ...
      (signature.parameters = parseParameterList(
        yieldContext,
        awaitContext,
    ...
    def parseParameterList(yieldContext: Boolean,
                           awaitContext: Boolean,
                           requireCompleteParameterList: Boolean) = {
      ...
      return (if (requireCompleteParameterList) undefined
              else createMissingList[ParameterDeclaration]())
    ...
    def parseSignatureMember(kind: SyntaxKind)
      : (CallSignatureDeclaration | ConstructSignatureDeclaration) = {
      val node = createNode(kind).asInstanceOf[
        (CallSignatureDeclaration | ConstructSignatureDeclaration)]
    ...
    def parseIndexSignatureDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): IndexSignatureDeclaration = {
      val node = createNode(SyntaxKind.IndexSignature, fullStart)
        .asInstanceOf[IndexSignatureDeclaration]
    ...
    def parsePropertyOrMethodSignature(fullStart: Int,
      ...
      if (((token() === SyntaxKind.OpenParenToken) || (token() === SyntaxKind.LessThanToken))) {
        val method = createNode(SyntaxKind.MethodSignature, fullStart)
        ...
        val property = createNode(SyntaxKind.PropertySignature, fullStart)
          .asInstanceOf[PropertySignature]
    ...
    def parseTypeMember(): TypeElement = {
      ...
      if (((token() === SyntaxKind.NewKeyword) && lookAhead(
    ...
    def parseTypeLiteral(): TypeLiteralNode = {
      val node = createNode(SyntaxKind.TypeLiteral)
        .asInstanceOf[TypeLiteralNode]
    ...
    def parseParenthesizedType(): ParenthesizedTypeNode = {
      val node = createNode(SyntaxKind.ParenthesizedType)
        .asInstanceOf[ParenthesizedTypeNode]
    ...
    def parseFunctionOrConstructorType(
        kind: SyntaxKind): FunctionOrConstructorTypeNode = {
    ...
    def parseLiteralTypeNode(): LiteralTypeNode = {
      val node = createNode(SyntaxKind.LiteralType)
        .asInstanceOf[LiteralTypeNode]
    ...
    def parseNonArrayType(): TypeNode = {
      token() match {
        case SyntaxKind.AnyKeyword | SyntaxKind.StringKeyword |
            ...
            SyntaxKind.SymbolKeyword | SyntaxKind.UndefinedKeyword |
    ...
    def isStartOfType(): Boolean = {
      token() match {
        case SyntaxKind.AnyKeyword | SyntaxKind.StringKeyword |
            ...
            SyntaxKind.ThisKeyword | SyntaxKind.TypeOfKeyword |
            SyntaxKind.NeverKeyword | SyntaxKind.OpenBraceToken |
            SyntaxKind.OpenBracketToken | SyntaxKind.LessThanToken |
            SyntaxKind.NewKeyword | SyntaxKind.StringLiteral |
    ...
    def parseArrayTypeOrHigher(): TypeNode = {
      ...
      while (((!scanner.hasPrecedingLineBreak()) && parseOptional(
               SyntaxKind.OpenBracketToken))) {
        {
          parseExpected(SyntaxKind.CloseBracketToken)
          val node = createNode(SyntaxKind.ArrayType, `type`.pos)
            .asInstanceOf[ArrayTypeNode]
    ...
    def parseUnionOrIntersectionType(kind: SyntaxKind,
                                     parseConstituentType: (() => TypeNode),
                                     operator: SyntaxKind): TypeNode = {
      ...
      if ((token() === operator)) {
        ...
        val node = createNode(kind, `type`.pos)
          .asInstanceOf[UnionOrIntersectionTypeNode]
        (node.types = types)
        (`type` = finishNode(node))
    ...
    def isStartOfFunctionType(): Boolean = {
      ...
      return ((token() === SyntaxKind.OpenParenToken) && lookAhead(
    ...
    def parseTypeOrTypePredicate(): TypeNode = {
      val typePredicateVariable = (isIdentifier() && tryParse(
    ...
    def parseTypeAnnotation(): TypeNode = {
      return (if (parseOptional(SyntaxKind.ColonToken)) parseType()
              else undefined)

    }
    def isStartOfLeftHandSideExpression(): Boolean = {
      token() match {
        case SyntaxKind.ThisKeyword | SyntaxKind.SuperKeyword |
            SyntaxKind.NullKeyword | SyntaxKind.TrueKeyword |
            SyntaxKind.FalseKeyword | SyntaxKind.NumericLiteral |
            SyntaxKind.StringLiteral |
            SyntaxKind.NoSubstitutionTemplateLiteral |
            SyntaxKind.TemplateHead | SyntaxKind.OpenParenToken |
            SyntaxKind.OpenBracketToken | SyntaxKind.OpenBraceToken |
            SyntaxKind.FunctionKeyword | SyntaxKind.ClassKeyword |
            SyntaxKind.NewKeyword | SyntaxKind.SlashToken |
            SyntaxKind.SlashEqualsToken | SyntaxKind.Identifier =>
          return true
        case _ =>
          return isIdentifier()
      }
    ...
    def isStartOfExpression(): Boolean = {
      ...
      token() match {
        case SyntaxKind.PlusToken | SyntaxKind.MinusToken |
            ...
            SyntaxKind.DeleteKeyword | SyntaxKind.TypeOfKeyword |
            SyntaxKind.VoidKeyword | SyntaxKind.PlusPlusToken |
            SyntaxKind.MinusMinusToken | SyntaxKind.LessThanToken |
            SyntaxKind.AwaitKeyword | SyntaxKind.YieldKeyword =>
          return true
        case _ =>
          if (isBinaryOperator()) {
            return true
    ...
    def parseInitializer(inParameter: Boolean): Expression = {
      if ((token() !== SyntaxKind.EqualsToken)) {
        if (((scanner
              .hasPrecedingLineBreak() || ((inParameter && (token() === SyntaxKind.OpenBraceToken)))) || (!isStartOfExpression()))) {
          return undefined
    ...
    def parseAssignmentExpressionOrHigher(): Expression = {
      ...
      if ((isLeftHandSideExpression(expr) && isAssignmentOperator(
        ...
        return makeBinaryExpression(
          expr,
          parseTokenNode().asInstanceOf[BinaryOperatorToken],
          parseAssignmentExpressionOrHigher())
    ...
    def parseYieldExpression(): YieldExpression = {
      val node = createNode(SyntaxKind.YieldExpression)
        .asInstanceOf[YieldExpression]
      nextToken()
      if (((!scanner
            .hasPrecedingLineBreak()) && (((token() === SyntaxKind.AsteriskToken) || isStartOfExpression())))) {
    ...
    def parseSimpleArrowFunctionExpression(
        identifier: Identifier,
        asyncModifier: NodeArray[Modifier]): ArrowFunction = {
      Debug.assert(
      ...
      val parameter = createNode(SyntaxKind.Parameter, identifier.pos)
        .asInstanceOf[ParameterDeclaration]
      (parameter.name = identifier)
      finishNode(parameter)
      (node.parameters =
        createNodeArray[ParameterDeclaration](Array(parameter), parameter.pos))
    ...
    def tryParseParenthesizedArrowFunctionExpression(): Expression = {
      ...
      val arrowFunction =
        (if ((triState === Tristate.True))
         ...
         else tryParse(parsePossibleParenthesizedArrowFunctionExpressionHead))
      if ((!arrowFunction)) {
        return undefined

      }
      val isAsync =
        (!(!((getModifierFlags(arrowFunction) & ModifierFlags.Async))))
      val lastToken = token()
    ...
    def isParenthesizedArrowFunctionExpressionWorker() = {
      ...
      if ((first === SyntaxKind.OpenParenToken)) {
        if ((second === SyntaxKind.CloseParenToken)) {
          val third = nextToken()
          third match {
            case SyntaxKind.EqualsGreaterThanToken | SyntaxKind.ColonToken |
    ...
    def parsePossibleParenthesizedArrowFunctionExpressionHead()
      : ArrowFunction = {
    ...
    def tryParseAsyncSimpleArrowFunctionExpression(): ArrowFunction = {
      if ((token() === SyntaxKind.AsyncKeyword)) {
        val isUnParenthesizedAsyncArrowFunction = lookAhead(
    ...
    def isUnParenthesizedAsyncArrowFunctionWorker(): Tristate = {
      if ((token() === SyntaxKind.AsyncKeyword)) {
        nextToken()
        if ((scanner
              .hasPrecedingLineBreak() || (token() === SyntaxKind.EqualsGreaterThanToken))) {
          return Tristate.False

        }
        val expr = parseBinaryExpressionOrHigher(0)
        if ((((!scanner
              .hasPrecedingLineBreak()) && (expr.kind === SyntaxKind.Identifier)) && (token() === SyntaxKind.EqualsGreaterThanToken))) {
          return Tristate.True
    ...
    def parseParenthesizedArrowFunctionExpressionHead(
        allowAmbiguity: Boolean): ArrowFunction = {
      val node = createNode(SyntaxKind.ArrowFunction)
        .asInstanceOf[ArrowFunction]
    ...
    def parseArrowFunctionExpressionBody(
        isAsync: Boolean): (Block | Expression) = {
      if ((token() === SyntaxKind.OpenBraceToken)) {
      ...
      return (if (isAsync) doInAwaitContext(parseAssignmentExpressionOrHigher)
              else doOutsideOfAwaitContext(parseAssignmentExpressionOrHigher))
    ...
    def parseConditionalExpressionRest(leftOperand: Expression): Expression = {
      ...
      val node = createNode(SyntaxKind.ConditionalExpression, leftOperand.pos)
        .asInstanceOf[ConditionalExpression]
      ...
      (node.whenTrue = doOutsideOfContext(
        ...
        parseAssignmentExpressionOrHigher))
      (node.colonToken = parseExpectedToken(
        SyntaxKind.ColonToken,
        false,
        Diagnostics._0_expected,
    ...
    def parseBinaryExpressionRest(precedence: Int,
                                  leftOperand: Expression): Expression = {
      while (true) {
        {
          reScanGreaterToken()
          val newPrecedence = getBinaryOperatorPrecedence()
          val consumeCurrentOperator =
            (if ((token() === SyntaxKind.AsteriskAsteriskToken))
               (newPrecedence >= precedence)
             else (newPrecedence > precedence))
    ...
    def getBinaryOperatorPrecedence(): Int = {
      token() match {
        ...
        case SyntaxKind.LessThanToken | SyntaxKind.GreaterThanToken |
            ...
            SyntaxKind.GreaterThanEqualsToken | SyntaxKind.InstanceOfKeyword |
            SyntaxKind.InKeyword | SyntaxKind.AsKeyword =>
          return 7
        ...
        case SyntaxKind.PlusToken | SyntaxKind.MinusToken =>
          return 9
        case SyntaxKind.AsteriskToken | SyntaxKind.SlashToken |
    ...
    def makeBinaryExpression(left: Expression,
                             operatorToken: BinaryOperatorToken,
                             right: Expression): BinaryExpression = {
      val node = createNode(SyntaxKind.BinaryExpression, left.pos)
    ...
    def makeAsExpression(left: Expression, right: TypeNode): AsExpression = {
      val node = createNode(SyntaxKind.AsExpression, left.pos)
        .asInstanceOf[AsExpression]
    ...
    def parsePrefixUnaryExpression() = {
      val node = createNode(SyntaxKind.PrefixUnaryExpression)
    ...
    def parseDeleteExpression() = {
      val node = createNode(SyntaxKind.DeleteExpression)
    ...
    def parseTypeOfExpression() = {
      val node = createNode(SyntaxKind.TypeOfExpression)
    ...
    def parseVoidExpression() = {
      val node = createNode(SyntaxKind.VoidExpression)
    ...
    def parseAwaitExpression() = {
      val node = createNode(SyntaxKind.AwaitExpression)
    ...
    def parseUnaryExpressionOrHigher()
      : (UnaryExpression | BinaryExpression) = {
      if (isUpdateExpression()) {
        val incrementExpression = parseIncrementExpression()
        return (if ((token() === SyntaxKind.AsteriskAsteriskToken))
                  parseBinaryExpressionRest(
                    getBinaryOperatorPrecedence(),
                    incrementExpression).asInstanceOf[BinaryExpression]
                else incrementExpression)
      ...
      if ((token() === SyntaxKind.AsteriskAsteriskToken)) {
        ...
        if ((simpleUnaryExpression.kind === SyntaxKind.TypeAssertionExpression)) {
          parseErrorAtPosition(
            start,
            (simpleUnaryExpression.end - start),
    ...
    def isUpdateExpression(): Boolean = {
      token() match {
        case SyntaxKind.PlusToken | SyntaxKind.MinusToken |
            SyntaxKind.TildeToken | SyntaxKind.ExclamationToken |
            SyntaxKind.DeleteKeyword | SyntaxKind.TypeOfKeyword |
            SyntaxKind.VoidKeyword | SyntaxKind.AwaitKeyword =>
          return false
        case SyntaxKind.LessThanToken =>
          if ((sourceFile.languageVariant !== LanguageVariant.JSX)) {
            return false
    ...
    def parseIncrementExpression(): IncrementExpression = {
      ...
      } else if ((((sourceFile.languageVariant === LanguageVariant.JSX) && (token() === SyntaxKind.LessThanToken)) && lookAhead(
      ...
      if (((((token() === SyntaxKind.PlusPlusToken) || (token() === SyntaxKind.MinusMinusToken))) && (!scanner
            .hasPrecedingLineBreak()))) {
        val node =
    ...
    def parseLeftHandSideExpressionOrHigher(): LeftHandSideExpression = {
      val expression =
        (if ((token() === SyntaxKind.SuperKeyword)) parseSuperExpression()
         else parseMemberExpressionOrHigher())
    ...
    def tagNamesAreEquivalent(lhs: JsxTagNameExpression,
                              rhs: JsxTagNameExpression): Boolean = {
      if ((lhs.kind !== rhs.kind)) {
        return false

      }
      if ((lhs.kind === SyntaxKind.Identifier)) {
        return ((lhs.asInstanceOf[Identifier]).text === (rhs
          .asInstanceOf[Identifier])
          .text)
      ...
      return (((lhs.asInstanceOf[PropertyAccessExpression]).name.text === (rhs
        .asInstanceOf[PropertyAccessExpression])
        .name
        .text) && tagNamesAreEquivalent(
        (lhs
          .asInstanceOf[PropertyAccessExpression])
          .expression
          .asInstanceOf[JsxTagNameExpression],
        (rhs
          .asInstanceOf[PropertyAccessExpression])
          .expression
          .asInstanceOf[JsxTagNameExpression]))
    ...
    def parseJsxElementOrSelfClosingElement(
        inExpressionContext: Boolean): (JsxElement | JsxSelfClosingElement) = {
      ...
      if ((opening.kind === SyntaxKind.JsxOpeningElement)) {
        val node = createNode(SyntaxKind.JsxElement, opening.pos)
          .asInstanceOf[JsxElement]
        (node.openingElement = opening)
        (node.children = parseJsxChildren(node.openingElement.tagName))
        (node.closingElement = parseJsxClosingElement(inExpressionContext))
        if ((!tagNamesAreEquivalent(
              node.openingElement.tagName,
              node.closingElement.tagName))) {
          parseErrorAtPosition(
            node.closingElement.pos,
            (node.closingElement.end - node.closingElement.pos),
      ...
      if ((inExpressionContext && (token() === SyntaxKind.LessThanToken))) {
        val invalidElement = tryParse(
          (() => parseJsxElementOrSelfClosingElement(true)))
        if (invalidElement) {
          parseErrorAtCurrentToken(
            Diagnostics.JSX_expressions_must_have_one_parent_element)
          val badNode = createNode(SyntaxKind.BinaryExpression, result.pos)
            .asInstanceOf[BinaryExpression]
          (badNode.end = invalidElement.end)
          (badNode.left = result)
          (badNode.right = invalidElement)
          (badNode.operatorToken =
            createMissingNode(SyntaxKind.CommaToken, false, undefined)
              .asInstanceOf[BinaryOperatorToken])
          (badNode.operatorToken.pos =
            (badNode.operatorToken.end = badNode.right.pos))
    ...
    def parseJsxText(): JsxText = {
      val node = createNode(SyntaxKind.JsxText, scanner.getStartPos())
        .asInstanceOf[JsxText]
    ...
    def parseJsxChildren(
        openingTagName: LeftHandSideExpression): NodeArray[JsxChild] = {
      ...
      while (true) {
        {
          ...
          if ((token() === SyntaxKind.LessThanSlashToken)) {
            ...
            parseErrorAtPosition(
              openingTagName.pos,
              (openingTagName.end - openingTagName.pos),
    ...
    def parseJsxOpeningOrSelfClosingElement(inExpressionContext: Boolean)
    ...
    def parseJsxElementName(): JsxTagNameExpression = {
      scanJsxIdentifier()
      var expression: JsxTagNameExpression =
        (if ((token() === SyntaxKind.ThisKeyword))
           parseTokenNode[PrimaryExpression]()
         else parseIdentifierName())
      while (parseOptional(SyntaxKind.DotToken)) {
        {
          val propertyAccess: PropertyAccessExpression =
            createNode(SyntaxKind.PropertyAccessExpression, expression.pos)
              .asInstanceOf[PropertyAccessExpression]
    ...
    def parseJsxExpression(inExpressionContext: Boolean): JsxExpression = {
      val node = createNode(SyntaxKind.JsxExpression)
    ...
    def parseJsxSpreadAttribute(): JsxSpreadAttribute = {
      val node = createNode(SyntaxKind.JsxSpreadAttribute)
    ...
    def parseJsxClosingElement(
        inExpressionContext: Boolean): JsxClosingElement = {
      val node = createNode(SyntaxKind.JsxClosingElement)
    ...
    def parseTypeAssertion(): TypeAssertion = {
      val node = createNode(SyntaxKind.TypeAssertionExpression)
        .asInstanceOf[TypeAssertion]
      parseExpected(SyntaxKind.LessThanToken)
      (node.`type` = parseType())
      parseExpected(SyntaxKind.GreaterThanToken)
      (node.expression = parseSimpleUnaryExpression())
    ...
    def parseMemberExpressionRest(
        expression: LeftHandSideExpression): MemberExpression = {
      while (true) {
        {
          ...
          if (((token() === SyntaxKind.ExclamationToken) && (!scanner
                .hasPrecedingLineBreak()))) {
            nextToken()
            val nonNullExpression =
              createNode(SyntaxKind.NonNullExpression, expression.pos)
                .asInstanceOf[NonNullExpression]
            (nonNullExpression.expression = expression)
            (expression = finishNode(nonNullExpression))
            continue

          }
          if (((!inDecoratorContext()) && parseOptional(
                SyntaxKind.OpenBracketToken))) {
            val indexedAccess =
            ...
            if ((token() !== SyntaxKind.CloseBracketToken)) {
              ...
              if (((indexedAccess.argumentExpression.kind === SyntaxKind.StringLiteral) || (indexedAccess.argumentExpression.kind === SyntaxKind.NumericLiteral))) {
                val literal = indexedAccess.argumentExpression
                  .asInstanceOf[LiteralExpression]
          ...
          if (((token() === SyntaxKind.NoSubstitutionTemplateLiteral) || (token() === SyntaxKind.TemplateHead))) {
            val tagExpression =
              createNode(SyntaxKind.TaggedTemplateExpression, expression.pos)
                .asInstanceOf[TaggedTemplateExpression]
            (tagExpression.tag = expression)
            (tagExpression.template =
              (if ((token() === SyntaxKind.NoSubstitutionTemplateLiteral))
                 parseLiteralNode().asInstanceOf[NoSubstitutionTemplateLiteral]
    ...
    def parseTypeArgumentsInExpression() = {
      ...
      val typeArguments =
        parseDelimitedList(ParsingContext.TypeArguments, parseType)
      if ((!parseExpected(SyntaxKind.GreaterThanToken))) {
        return undefined

      }
      return (if ((typeArguments && canFollowTypeArgumentsInExpression()))
                typeArguments
              else undefined)
    ...
    def parsePrimaryExpression(): PrimaryExpression = {
      token() match {
        case SyntaxKind.NumericLiteral | SyntaxKind.StringLiteral |
            SyntaxKind.NoSubstitutionTemplateLiteral =>
    ...
    def parseParenthesizedExpression(): ParenthesizedExpression = {
      val node = createNode(SyntaxKind.ParenthesizedExpression)
    ...
    def parseSpreadElement(): Expression = {
      val node = createNode(SyntaxKind.SpreadElementExpression)
    ...
    def parseArgumentOrArrayLiteralElement(): Expression = {
      return (if ((token() === SyntaxKind.DotDotDotToken)) parseSpreadElement()
              else
    ...
    def parseArrayLiteralExpression(): ArrayLiteralExpression = {
      val node = createNode(SyntaxKind.ArrayLiteralExpression)
    ...
    def tryParseAccessorDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): AccessorDeclaration = {
    ...
    def parseObjectLiteralElement(): ObjectLiteralElementLike = {
      ...
      val modifiers = parseModifiers()
      val accessor =
        tryParseAccessorDeclaration(fullStart, decorators, modifiers)
      if (accessor) {
        return accessor
      ...
      if (isShorthandPropertyAssignment) {
        val shorthandDeclaration =
          createNode(SyntaxKind.ShorthandPropertyAssignment, fullStart)
            .asInstanceOf[ShorthandPropertyAssignment]
        ...
        if (equalsToken) {
          ...
          (shorthandDeclaration.objectAssignmentInitializer = allowInAnd(
            parseAssignmentExpressionOrHigher))
        ...
        val propertyAssignment =
          createNode(SyntaxKind.PropertyAssignment, fullStart)
            .asInstanceOf[PropertyAssignment]
        (propertyAssignment.modifiers = modifiers)
        (propertyAssignment.name = propertyName)
        (propertyAssignment.questionToken = questionToken)
        parseExpected(SyntaxKind.ColonToken)
        (propertyAssignment.initializer = allowInAnd(
          parseAssignmentExpressionOrHigher))
    ...
    def parseObjectLiteralExpression(): ObjectLiteralExpression = {
      val node = createNode(SyntaxKind.ObjectLiteralExpression)
    ...
    def parseFunctionExpression(): FunctionExpression = {
      ...
      val node = createNode(SyntaxKind.FunctionExpression)
      ...
      (node.name =
        (if ((isGenerator && isAsync))
         ...
         else (if (isGenerator) doInYieldContext(parseOptionalIdentifier)
               else (if (isAsync) doInAwaitContext(parseOptionalIdentifier)
                     else parseOptionalIdentifier()))))
    ...
    def parseNewExpression(): NewExpression = {
      val node = createNode(SyntaxKind.NewExpression)
    ...
    def parseBlock(ignoreMissingOpenBrace: Boolean,
      ...
      if ((parseExpected(SyntaxKind.OpenBraceToken, diagnosticMessage) || ignoreMissingOpenBrace)) {
        ...
        (node.statements =
          parseList(ParsingContext.BlockStatements, parseStatement))
        parseExpected(SyntaxKind.CloseBraceToken)
    ...
    def parseFunctionBlock(allowYield: Boolean,
                           allowAwait: Boolean,
    ...
    def parseIfStatement(): IfStatement = {
      ...
      (node.elseStatement =
        (if (parseOptional(SyntaxKind.ElseKeyword)) parseStatement()
         else undefined))
      return finishNode(node)
    ...
    def parseWhileStatement(): WhileStatement = {
      val node = createNode(SyntaxKind.WhileStatement)
    ...
    def parseForOrForInOrForOfStatement(): Statement = {
      ...
      if (parseOptional(SyntaxKind.InKeyword)) {
        val forInStatement = createNode(SyntaxKind.ForInStatement, pos)
        ...
        val forOfStatement = createNode(SyntaxKind.ForOfStatement, pos)
          .asInstanceOf[ForOfStatement]
        (forOfStatement.initializer = initializer)
        (forOfStatement.expression = allowInAnd(
          parseAssignmentExpressionOrHigher))
        parseExpected(SyntaxKind.CloseParenToken)
        ...
        val forStatement =
          createNode(SyntaxKind.ForStatement, pos).asInstanceOf[ForStatement]
    ...
    def parseBreakOrContinueStatement(
        kind: SyntaxKind): BreakOrContinueStatement = {
      val node = createNode(kind).asInstanceOf[BreakOrContinueStatement]
      parseExpected(
        (if ((kind === SyntaxKind.BreakStatement)) SyntaxKind.BreakKeyword
         else SyntaxKind.ContinueKeyword))
      if ((!canParseSemicolon())) {
    ...
    def parseReturnStatement(): ReturnStatement = {
      val node = createNode(SyntaxKind.ReturnStatement)
    ...
    def parseWithStatement(): WithStatement = {
      val node = createNode(SyntaxKind.WithStatement)
    ...
    def parseDefaultClause(): DefaultClause = {
      val node = createNode(SyntaxKind.DefaultClause)
    ...
    def parseCaseOrDefaultClause(): CaseOrDefaultClause = {
      return (if ((token() === SyntaxKind.CaseKeyword)) parseCaseClause()
              else parseDefaultClause())

    }
    def parseSwitchStatement(): SwitchStatement = {
      val node = createNode(SyntaxKind.SwitchStatement)
        .asInstanceOf[SwitchStatement]
      parseExpected(SyntaxKind.SwitchKeyword)
      parseExpected(SyntaxKind.OpenParenToken)
      (node.expression = allowInAnd(parseExpression))
      parseExpected(SyntaxKind.CloseParenToken)
      val caseBlock = createNode(SyntaxKind.CaseBlock, scanner.getStartPos())
        .asInstanceOf[CaseBlock]
      parseExpected(SyntaxKind.OpenBraceToken)
      (caseBlock.clauses =
        parseList(ParsingContext.SwitchClauses, parseCaseOrDefaultClause))
      parseExpected(SyntaxKind.CloseBraceToken)
    ...
    def parseThrowStatement(): ThrowStatement = {
      val node = createNode(SyntaxKind.ThrowStatement)
        .asInstanceOf[ThrowStatement]
      parseExpected(SyntaxKind.ThrowKeyword)
      (node.expression =
        (if (scanner.hasPrecedingLineBreak()) undefined
         else allowInAnd(parseExpression)))
      parseSemicolon()
      return finishNode(node)
    ...
    def parseTryStatement(): TryStatement = {
      ...
      (node.catchClause =
        (if ((token() === SyntaxKind.CatchKeyword)) parseCatchClause()
         else undefined))
    ...
    def parseDebuggerStatement(): Statement = {
      val node = createNode(SyntaxKind.DebuggerStatement)
    ...
    def parseExpressionOrLabeledStatement()
      : (ExpressionStatement | LabeledStatement) = {
      val fullStart = scanner.getStartPos()
      val expression = allowInAnd(parseExpression)
      if (((expression.kind === SyntaxKind.Identifier) && parseOptional(
            SyntaxKind.ColonToken))) {
        val labeledStatement =
          createNode(SyntaxKind.LabeledStatement, fullStart)
        ...
        val expressionStatement =
          createNode(SyntaxKind.ExpressionStatement, fullStart)
    ...
    def nextTokenIsIdentifierOrKeywordOnSameLine() = {
      nextToken()
      return (tokenIsIdentifierOrKeyword(token()) && (!scanner
        .hasPrecedingLineBreak()))

    }
    def nextTokenIsFunctionKeywordOnSameLine() = {
      nextToken()
      return ((token() === SyntaxKind.FunctionKeyword) && (!scanner
        .hasPrecedingLineBreak()))

    }
    def nextTokenIsIdentifierOrKeywordOrNumberOnSameLine() = {
      nextToken()
      return (((tokenIsIdentifierOrKeyword(token()) || (token() === SyntaxKind.NumericLiteral))) && (!scanner
        .hasPrecedingLineBreak()))
    ...
    def isDeclaration(): Boolean = {
      while (true) {
        {
          token() match {
            case SyntaxKind.VarKeyword | SyntaxKind.LetKeyword |
                SyntaxKind.ConstKeyword | SyntaxKind.FunctionKeyword |
            ...
            case SyntaxKind.AbstractKeyword | SyntaxKind.AsyncKeyword |
                SyntaxKind.DeclareKeyword | SyntaxKind.PrivateKeyword |
            ...
            case SyntaxKind.ImportKeyword =>
              nextToken()
              return ((((token() === SyntaxKind.StringLiteral) || (token() === SyntaxKind.AsteriskToken)) || (token() === SyntaxKind.OpenBraceToken)) || tokenIsIdentifierOrKeyword(
                token()))
    ...
    def isStartOfStatement(): Boolean = {
      token() match {
        case SyntaxKind.AtToken | SyntaxKind.SemicolonToken |
            SyntaxKind.OpenBraceToken | SyntaxKind.VarKeyword |
            SyntaxKind.LetKeyword | SyntaxKind.FunctionKeyword |
            SyntaxKind.ClassKeyword | SyntaxKind.EnumKeyword |
            SyntaxKind.IfKeyword | SyntaxKind.DoKeyword |
            SyntaxKind.WhileKeyword | SyntaxKind.ForKeyword |
            SyntaxKind.ContinueKeyword | SyntaxKind.BreakKeyword |
            SyntaxKind.ReturnKeyword | SyntaxKind.WithKeyword |
            SyntaxKind.SwitchKeyword | SyntaxKind.ThrowKeyword |
            SyntaxKind.TryKeyword | SyntaxKind.DebuggerKeyword |
            SyntaxKind.CatchKeyword | SyntaxKind.FinallyKeyword =>
          return true
        case SyntaxKind.ConstKeyword | SyntaxKind.ExportKeyword |
            SyntaxKind.ImportKeyword =>
          return isStartOfDeclaration()
        case SyntaxKind.AsyncKeyword | SyntaxKind.DeclareKeyword |
            SyntaxKind.InterfaceKeyword | SyntaxKind.ModuleKeyword |
            SyntaxKind.NamespaceKeyword | SyntaxKind.TypeKeyword |
            SyntaxKind.GlobalKeyword =>
          return true
        case SyntaxKind.PublicKeyword | SyntaxKind.PrivateKeyword |
            SyntaxKind.ProtectedKeyword | SyntaxKind.StaticKeyword |
            SyntaxKind.ReadonlyKeyword =>
          return (isStartOfDeclaration() || (!lookAhead(
            nextTokenIsIdentifierOrKeywordOnSameLine)))
        case _ =>
          return isStartOfExpression()
      }
    ...
    def parseStatement(): Statement = {
      token() match {
        ...
        case SyntaxKind.TryKeyword | SyntaxKind.CatchKeyword |
        ...
        case SyntaxKind.AsyncKeyword | SyntaxKind.InterfaceKeyword |
            SyntaxKind.TypeKeyword | SyntaxKind.ModuleKeyword |
            SyntaxKind.NamespaceKeyword | SyntaxKind.DeclareKeyword |
            SyntaxKind.ConstKeyword | SyntaxKind.EnumKeyword |
            SyntaxKind.ExportKeyword | SyntaxKind.ImportKeyword |
    ...
    def parseDeclaration(): Statement = {
      ...
      token() match {
        ...
        case SyntaxKind.GlobalKeyword | SyntaxKind.ModuleKeyword |
        ...
        case _ =>
          if ((decorators || modifiers)) {
            val node = createMissingNode(
              SyntaxKind.MissingDeclaration,
              true,
              Diagnostics.Declaration_expected).asInstanceOf[Statement]
            (node.pos = fullStart)
            (node.decorators = decorators)
            (node.modifiers = modifiers)
            return finishNode(node)
    ...
    def nextTokenIsIdentifierOrStringLiteralOnSameLine() = {
      nextToken()
      return ((!scanner
        .hasPrecedingLineBreak()) && ((isIdentifier() || (token() === SyntaxKind.StringLiteral))))

    }
    def parseFunctionBlockOrSemicolon(
        isGenerator: Boolean,
        isAsync: Boolean,
        diagnosticMessage: DiagnosticMessage): Block = {
    ...
    def parseArrayBindingElement(): ArrayBindingElement = {
      ...
      val node = createNode(SyntaxKind.BindingElement)
    ...
    def parseObjectBindingPattern(): ObjectBindingPattern = {
      val node = createNode(SyntaxKind.ObjectBindingPattern)
    ...
    def parseArrayBindingPattern(): ArrayBindingPattern = {
      val node = createNode(SyntaxKind.ArrayBindingPattern)
    ...
    def parseVariableDeclaration(): VariableDeclaration = {
      val node = createNode(SyntaxKind.VariableDeclaration)
    ...
    def parseVariableDeclarationList(
        inForStatementInitializer: Boolean): VariableDeclarationList = {
      val node = createNode(SyntaxKind.VariableDeclarationList)
      ...
      nextToken()
      if (((token() === SyntaxKind.OfKeyword) && lookAhead(
    ...
    def parseVariableStatement(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): VariableStatement = {
      val node = createNode(SyntaxKind.VariableStatement, fullStart)
    ...
    def parseFunctionDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): FunctionDeclaration = {
      val node = createNode(SyntaxKind.FunctionDeclaration, fullStart)
    ...
    def parseConstructorDeclaration(
        pos: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ConstructorDeclaration = {
      val node = createNode(SyntaxKind.Constructor, pos)
      ...
      fillSignature(SyntaxKind.ColonToken, false, false, false, node)
      (node.body =
        parseFunctionBlockOrSemicolon(false, false, Diagnostics.or_expected))
      return addJSDocComment(finishNode(node))
    ...
    def parseMethodDeclaration(
      ...
      val method = createNode(SyntaxKind.MethodDeclaration, fullStart)
      ...
      (method.body =
        parseFunctionBlockOrSemicolon(isGenerator, isAsync, diagnosticMessage))
      return addJSDocComment(finishNode(method))

    }
    def parsePropertyDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier],
        name: PropertyName,
        questionToken: QuestionToken): ClassElement = {
      val property = createNode(SyntaxKind.PropertyDeclaration, fullStart)
    ...
    def parsePropertyOrMethodDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ClassElement = {
      val asteriskToken = parseOptionalToken(SyntaxKind.AsteriskToken)
      val name = parsePropertyName()
      val questionToken = parseOptionalToken(SyntaxKind.QuestionToken)
      if (((asteriskToken || (token() === SyntaxKind.OpenParenToken)) || (token() === SyntaxKind.LessThanToken))) {
    ...
    def isClassMemberStart(): Boolean = {
      ...
      if ((idToken !== undefined)) {
        ...
        token() match {
          case SyntaxKind.OpenParenToken | SyntaxKind.LessThanToken |
      ...
      while (true) {
        {
          ...
          val decorator = createNode(SyntaxKind.Decorator, decoratorStart)
            .asInstanceOf[Decorator]
          (decorator.expression = doInDecoratorContext(
            parseLeftHandSideExpressionOrHigher))
          finishNode(decorator)
          if ((!decorators)) {
            (decorators =
              createNodeArray[Decorator](Array(decorator), decoratorStart))
    ...
    def parseModifiers(
        permitInvalidConstAsModifier: Boolean): NodeArray[Modifier] = {
      ...
      while (true) {
        {
          ...
          val modifier = finishNode(
            createNode(modifierKind, modifierStart).asInstanceOf[Modifier])
          if ((!modifiers)) {
            (modifiers =
              createNodeArray[Modifier](Array(modifier), modifierStart))
    ...
    def parseClassElement(): ClassElement = {
      if ((token() === SyntaxKind.SemicolonToken)) {
        val result = createNode(SyntaxKind.SemicolonClassElement)
          .asInstanceOf[SemicolonClassElement]
        nextToken()
        return finishNode(result)
      ...
      if ((decorators || modifiers)) {
        val name = createMissingNode(
          SyntaxKind.Identifier,
          true,
          Diagnostics.Declaration_expected).asInstanceOf[Identifier]
        return parsePropertyDeclaration(
          fullStart,
          decorators,
          modifiers,
    ...
    def parseClassExpression(): ClassExpression = {
      return parseClassDeclarationOrExpression(
        ...
        undefined,
        undefined,
        SyntaxKind.ClassExpression).asInstanceOf[ClassExpression]

    }
    def parseClassDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ClassDeclaration = {
      return parseClassDeclarationOrExpression(
        fullStart,
        decorators,
        modifiers,
        SyntaxKind.ClassDeclaration).asInstanceOf[ClassDeclaration]

    }
    def parseClassDeclarationOrExpression(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier],
        kind: SyntaxKind): ClassLikeDeclaration = {
    ...
    def parseNameOfClassDeclarationOrExpression(): Identifier = {
      return (if ((isIdentifier() && (!isImplementsClause())))
                parseIdentifier()
              else undefined)

    }
    def isImplementsClause() = {
      return ((token() === SyntaxKind.ImplementsKeyword) && lookAhead(
        nextTokenIsIdentifierOrKeyword))
    ...
    def parseHeritageClause() = {
      if (((token() === SyntaxKind.ExtendsKeyword) || (token() === SyntaxKind.ImplementsKeyword))) {
        val node = createNode(SyntaxKind.HeritageClause)
    ...
    def parseExpressionWithTypeArguments(): ExpressionWithTypeArguments = {
      val node = createNode(SyntaxKind.ExpressionWithTypeArguments)
        .asInstanceOf[ExpressionWithTypeArguments]
    ...
    def parseInterfaceDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): InterfaceDeclaration = {
      val node = createNode(SyntaxKind.InterfaceDeclaration, fullStart)
        .asInstanceOf[InterfaceDeclaration]
      (node.decorators = decorators)
      (node.modifiers = modifiers)
    ...
    def parseTypeAliasDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): TypeAliasDeclaration = {
      val node = createNode(SyntaxKind.TypeAliasDeclaration, fullStart)
        .asInstanceOf[TypeAliasDeclaration]
      (node.decorators = decorators)
      (node.modifiers = modifiers)
    ...
    def parseEnumMember(): EnumMember = {
      val node = createNode(SyntaxKind.EnumMember, scanner.getStartPos())
        .asInstanceOf[EnumMember]
      (node.name = parsePropertyName())
    ...
    def parseEnumDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): EnumDeclaration = {
      val node = createNode(SyntaxKind.EnumDeclaration, fullStart)
        .asInstanceOf[EnumDeclaration]
      (node.decorators = decorators)
      (node.modifiers = modifiers)
    ...
    def parseModuleBlock(): ModuleBlock = {
      val node = createNode(SyntaxKind.ModuleBlock, scanner.getStartPos())
    ...
    def parseModuleOrNamespaceDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier],
        flags: NodeFlags): ModuleDeclaration = {
      val node = createNode(SyntaxKind.ModuleDeclaration, fullStart)
      ...
      (node.body =
        (if (parseOptional(SyntaxKind.DotToken))
           parseModuleOrNamespaceDeclaration(
             ...
             .asInstanceOf[NamespaceDeclaration]
         else parseModuleBlock()))
      return addJSDocComment(finishNode(node))

    }
    def parseAmbientExternalModuleDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ModuleDeclaration = {
      val node = createNode(SyntaxKind.ModuleDeclaration, fullStart)
        .asInstanceOf[ModuleDeclaration]
      (node.decorators = decorators)
      (node.modifiers = modifiers)
    ...
    def isExternalModuleReference() = {
      return ((token() === SyntaxKind.RequireKeyword) && lookAhead(
    ...
    def parseNamespaceExportDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): NamespaceExportDeclaration = {
      val exportDeclaration =
        createNode(SyntaxKind.NamespaceExportDeclaration, fullStart)
          .asInstanceOf[NamespaceExportDeclaration]
    ...
    def parseImportDeclarationOrImportEqualsDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier])
      ...
      if (isIdentifier()) {
        ...
        if (((token() !== SyntaxKind.CommaToken) && (token() !== SyntaxKind.FromKeyword))) {
          val importEqualsDeclaration =
            createNode(SyntaxKind.ImportEqualsDeclaration, fullStart)
      ...
      val importDeclaration =
        createNode(SyntaxKind.ImportDeclaration, fullStart)
      ...
      if (((identifier || (token() === SyntaxKind.AsteriskToken)) || (token() === SyntaxKind.OpenBraceToken))) {
        (importDeclaration.importClause =
          parseImportClause(identifier, afterImportPos))
    ...
    def parseImportClause(identifier: Identifier, fullStart: Int) = {
      val importClause = createNode(SyntaxKind.ImportClause, fullStart)
        .asInstanceOf[ImportClause]
      if (identifier) {
      ...
      if (((!importClause.name) || parseOptional(SyntaxKind.CommaToken))) {
        (importClause.namedBindings =
          (if ((token() === SyntaxKind.AsteriskToken)) parseNamespaceImport()
           else parseNamedImportsOrExports(SyntaxKind.NamedImports)))
    ...
    def parseModuleReference() = {
      return (if (isExternalModuleReference()) parseExternalModuleReference()
              else parseEntityName(false))

    }
    def parseExternalModuleReference() = {
      val node = createNode(SyntaxKind.ExternalModuleReference)
        .asInstanceOf[ExternalModuleReference]
    ...
    def parseNamespaceImport(): NamespaceImport = {
      val namespaceImport = createNode(SyntaxKind.NamespaceImport)
    ...
    def parseNamedImportsOrExports(kind: SyntaxKind): NamedImportsOrExports = {
      ...
      (node.elements = parseBracketedList(
        ParsingContext.ImportOrExportSpecifiers,
        (if ((kind === SyntaxKind.NamedImports)) parseImportSpecifier
         else parseExportSpecifier),
        SyntaxKind.OpenBraceToken,
        SyntaxKind.CloseBraceToken)
        .asInstanceOf[(NodeArray[ImportSpecifier] | NodeArray[
          ExportSpecifier])])
      return finishNode(node)
    ...
    def parseImportOrExportSpecifier(
      ...
      if (((kind === SyntaxKind.ImportSpecifier) && checkIdentifierIsKeyword)) {
        parseErrorAtPosition(
          ...
          (checkIdentifierEnd - checkIdentifierStart),
    ...
    def parseExportDeclaration(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ExportDeclaration = {
      val node = createNode(SyntaxKind.ExportDeclaration, fullStart)
      ...
      if (parseOptional(SyntaxKind.AsteriskToken)) {
        ...
        if (((token() === SyntaxKind.FromKeyword) || (((token() === SyntaxKind.StringLiteral) && (!scanner
              .hasPrecedingLineBreak()))))) {
          parseExpected(SyntaxKind.FromKeyword)
          (node.moduleSpecifier = parseModuleSpecifier())
    ...
    def parseExportAssignment(
        fullStart: Int,
        decorators: NodeArray[Decorator],
        modifiers: NodeArray[Modifier]): ExportAssignment = {
      val node = createNode(SyntaxKind.ExportAssignment, fullStart)
    ...
    def processReferenceComments(sourceFile: SourceFile): Unit = {
      val triviaScanner = createScanner(
      ...
      while (true) {
        {
          ...
          val referencePathMatchResult =
            getFileReferenceFromReferencePath(comment, range)
          if (referencePathMatchResult) {
            val fileReference = referencePathMatchResult.fileReference
            (sourceFile.hasNoDefaultLib =
              referencePathMatchResult.isNoDefaultLib)
            ...
            val amdModuleNameRegEx = java.util.regex.Pattern.compile(
              raw"""^\/\/\/\s*<amd-module\s+name\s*=\s*('|")(.+?)\1""",
              "gim")
            ...
            val amdDependencyRegEx = java.util.regex.Pattern
              .compile(raw"""^\/\/\/\s*<amd-dependency\s""", "gim")
            val pathRegex = java.util.regex.Pattern
              .compile(raw"""\spath\s*=\s*('|")(.+?)\1""", "gim")
            val nameRegex = java.util.regex.Pattern
              .compile(raw"""\sname\s*=\s*('|")(.+?)\1""", "gim")
            ...
            if (amdDependencyMatchResult) {
              ...
              if (pathMatchResult) {
                val amdDependency = Map(
                  "path" -> pathMatchResult(2),
                  "name" -> (if (nameMatchResult) nameMatchResult(2)
                             else undefined))
    ...
    def setExternalModuleIndicator(sourceFile: SourceFile) = {
      (sourceFile.externalModuleIndicator = forEach(
        sourceFile.statements,
        (node =>
           (if (((((hasModifier(node, ModifierFlags.Export) || ((node.kind === SyntaxKind.ImportEqualsDeclaration) && ((node
                  .asInstanceOf[ImportEqualsDeclaration])
                  .moduleReference
                  .kind === SyntaxKind.ExternalModuleReference))) || (node.kind === SyntaxKind.ImportDeclaration)) || (node.kind === SyntaxKind.ExportAssignment)) || (node.kind === SyntaxKind.ExportDeclaration)))
              node
            else undefined))))
    ...
    object JSDocParser {
      def isJSDocType() = {
        token() match {
          case SyntaxKind.AsteriskToken | SyntaxKind.QuestionToken |
              SyntaxKind.OpenParenToken | SyntaxKind.OpenBracketToken |
              SyntaxKind.ExclamationToken | SyntaxKind.OpenBraceToken |
              SyntaxKind.FunctionKeyword | SyntaxKind.DotDotDotToken |
              SyntaxKind.NewKeyword | SyntaxKind.ThisKeyword =>
            return true
          case _ =>
        }
        return tokenIsIdentifierOrKeyword(token())
      ...
      def parseJSDocTypeExpression(): JSDocTypeExpression = {
        val result =
          createNode(SyntaxKind.JSDocTypeExpression, scanner.getTokenPos())
            .asInstanceOf[JSDocTypeExpression]
        parseExpected(SyntaxKind.OpenBraceToken)
      ...
      def parseJSDocTopLevelType(): JSDocType = {
        ...
        if ((token() === SyntaxKind.BarToken)) {
          val unionType = createNode(SyntaxKind.JSDocUnionType, `type`.pos)
            .asInstanceOf[JSDocUnionType]
        ...
        if ((token() === SyntaxKind.EqualsToken)) {
          val optionalType =
            createNode(SyntaxKind.JSDocOptionalType, `type`.pos)
              .asInstanceOf[JSDocOptionalType]
          nextToken()
      ...
      def parseJSDocType(): JSDocType = {
        ...
        while (true) {
          {
            if ((token() === SyntaxKind.OpenBracketToken)) {
              val arrayType = createNode(SyntaxKind.JSDocArrayType, `type`.pos)
                .asInstanceOf[JSDocArrayType]
              ...
              val nullableType =
                createNode(SyntaxKind.JSDocNullableType, `type`.pos)
                  .asInstanceOf[JSDocNullableType]
              ...
              val nonNullableType =
                createNode(SyntaxKind.JSDocNonNullableType, `type`.pos)
                  .asInstanceOf[JSDocNonNullableType]
      ...
      def parseJSDocThisType(): JSDocThisType = {
        val result = createNode(SyntaxKind.JSDocThisType)
          .asInstanceOf[JSDocThisType]
        nextToken()
        parseExpected(SyntaxKind.ColonToken)
      ...
      def parseJSDocConstructorType(): JSDocConstructorType = {
        val result = createNode(SyntaxKind.JSDocConstructorType)
          .asInstanceOf[JSDocConstructorType]
        nextToken()
        parseExpected(SyntaxKind.ColonToken)
        (result.`type` = parseJSDocType())
        return finishNode(result)
      ...
      def parseJSDocVariadicType(): JSDocVariadicType = {
        val result = createNode(SyntaxKind.JSDocVariadicType)
          .asInstanceOf[JSDocVariadicType]
        nextToken()
        (result.`type` = parseJSDocType())
        return finishNode(result)
      ...
      def parseJSDocFunctionType(): JSDocFunctionType = {
        val result = createNode(SyntaxKind.JSDocFunctionType)
          .asInstanceOf[JSDocFunctionType]
        nextToken()
        parseExpected(SyntaxKind.OpenParenToken)
        (result.parameters = parseDelimitedList(
          ParsingContext.JSDocFunctionParameters,
          parseJSDocParameter))
      ...
      def parseJSDocParameter(): ParameterDeclaration = {
        val parameter = createNode(SyntaxKind.Parameter)
          .asInstanceOf[ParameterDeclaration]
        (parameter.`type` = parseJSDocType())
        if (parseOptional(SyntaxKind.EqualsToken)) {
          (parameter.questionToken = createNode(SyntaxKind.EqualsToken)
            .asInstanceOf[QuestionToken])
      ...
      def parseJSDocTypeReference(): JSDocTypeReference = {
        val result = createNode(SyntaxKind.JSDocTypeReference)
          .asInstanceOf[JSDocTypeReference]
      ...
      def parseTypeArguments() = {
        nextToken()
        val typeArguments =
          parseDelimitedList(ParsingContext.JSDocTypeArguments, parseJSDocType)
      ...
      def parseQualifiedName(left: EntityName): QualifiedName = {
        val result = createNode(SyntaxKind.QualifiedName, left.pos)
          .asInstanceOf[QualifiedName]
        (result.left = left)
      ...
      def parseJSDocRecordType(): JSDocRecordType = {
        val result = createNode(SyntaxKind.JSDocRecordType)
          .asInstanceOf[JSDocRecordType]
        (result.literal = parseTypeLiteral())
        return finishNode(result)

      }
      def parseJSDocNonNullableType(): JSDocNonNullableType = {
        val result = createNode(SyntaxKind.JSDocNonNullableType)
          .asInstanceOf[JSDocNonNullableType]
        nextToken()
        (result.`type` = parseJSDocType())
        return finishNode(result)
      ...
      def parseJSDocTupleType(): JSDocTupleType = {
        val result = createNode(SyntaxKind.JSDocTupleType)
          .asInstanceOf[JSDocTupleType]
        nextToken()
        (result.types =
          parseDelimitedList(ParsingContext.JSDocTupleTypes, parseJSDocType))
      ...
      def parseJSDocUnionType(): JSDocUnionType = {
        val result = createNode(SyntaxKind.JSDocUnionType)
          .asInstanceOf[JSDocUnionType]
        nextToken()
      ...
      def parseJSDocAllType(): JSDocAllType = {
        val result = createNode(SyntaxKind.JSDocAllType)
          .asInstanceOf[JSDocAllType]
        nextToken()
        return finishNode(result)

      }
      def parseJSDocLiteralType(): JSDocLiteralType = {
        val result = createNode(SyntaxKind.JSDocLiteralType)
          .asInstanceOf[JSDocLiteralType]
        (result.literal = parseLiteralTypeNode())
        return finishNode(result)

      }
      def parseJSDocUnknownOrNullableType()
        : (JSDocUnknownType | JSDocNullableType) = {
        ...
        if (((((((token() === SyntaxKind.CommaToken) || (token() === SyntaxKind.CloseBraceToken)) || (token() === SyntaxKind.CloseParenToken)) || (token() === SyntaxKind.GreaterThanToken)) || (token() === SyntaxKind.EqualsToken)) || (token() === SyntaxKind.BarToken))) {
          val result = createNode(SyntaxKind.JSDocUnknownType, pos)
            .asInstanceOf[JSDocUnknownType]
          return finishNode(result)

        } else {
          val result = createNode(SyntaxKind.JSDocNullableType, pos)
            .asInstanceOf[JSDocNullableType]
          (result.`type` = parseJSDocType())
          return finishNode(result)
      ...
      def parseIsolatedJSDocComment(content: String, start: Int, length: Int) = {
        initializeState(content, ScriptTarget.Latest, undefined, ScriptKind.JS)
        (sourceFile =
          Map("languageVariant" -> LanguageVariant.Standard, "text" -> content)
            .asInstanceOf[SourceFile])
        val jsDoc = parseJSDocCommentWorker(start, length)
        val diagnostics = parseDiagnostics
        clearState()
        return (if (jsDoc) Map("jsDoc" -> jsDoc, "diagnostics" -> diagnostics)
                else undefined)
      ...
      def parseJSDocCommentWorker(start: Int, length: Int): JSDoc = {
        ...
        (start = (start || 0))
        val end =
          (if ((length === undefined)) content.length else (start + length))
        (length = (end - start))
        ...
        scanner.scanRange(
          ...
          (() => {
             ...
             var indent = ((start - Math
                 .max(content.lastIndexOf("\n", start), 0)) + 4)
        ...
        def isJsDocStart(content: String, start: Int) = {
          return ((((content.charCodeAt(start) === CharacterCodes.slash) && (content
            .charCodeAt((start + 1)) === CharacterCodes.asterisk)) && (content
            .charCodeAt((start + 2)) === CharacterCodes.asterisk)) && (content
            .charCodeAt((start + 3)) !== CharacterCodes.asterisk))

        }
        def createJSDocComment(): JSDoc = {
          val result =
            createNode(SyntaxKind.JSDocComment, start).asInstanceOf[JSDoc]
          (result.tags = tags)
          (result.comment =
            (if (comments.length) comments.join("") else undefined))
        ...
        def parseUnknownTag(atToken: AtToken, tagName: Identifier) = {
          val result =
            createNode(SyntaxKind.JSDocTag, atToken.pos).asInstanceOf[JSDocTag]
        ...
        def parseParamTag(atToken: AtToken, tagName: Identifier) = {
          ...
          val result = createNode(SyntaxKind.JSDocParameterTag, atToken.pos)
            .asInstanceOf[JSDocParameterTag]
          (result.atToken = atToken)
          (result.tagName = tagName)
        ...
        def parseReturnTag(atToken: AtToken,
                           tagName: Identifier): JSDocReturnTag = {
          if (forEach(tags, (t => (t.kind === SyntaxKind.JSDocReturnTag)))) {
            parseErrorAtPosition(
              tagName.pos,
              (scanner.getTokenPos() - tagName.pos),
              Diagnostics._0_tag_already_specified,
              tagName.text)

          }
          val result = createNode(SyntaxKind.JSDocReturnTag, atToken.pos)
            .asInstanceOf[JSDocReturnTag]
          (result.atToken = atToken)
          (result.tagName = tagName)
        ...
        def parseTypeTag(atToken: AtToken, tagName: Identifier): JSDocTypeTag = {
          ...
          val result = createNode(SyntaxKind.JSDocTypeTag, atToken.pos)
            .asInstanceOf[JSDocTypeTag]
          (result.atToken = atToken)
          (result.tagName = tagName)
          (result.typeExpression = tryParseTypeExpression())
          return finishNode(result)
        ...
        def parsePropertyTag(atToken: AtToken,
                             tagName: Identifier): JSDocPropertyTag = {
          ...
          val result = createNode(SyntaxKind.JSDocPropertyTag, atToken.pos)
        ...
        def parseTypedefTag(atToken: AtToken,
                            tagName: Identifier): JSDocTypedefTag = {
          val typeExpression = tryParseTypeExpression()
          skipWhitespace()
          val typedefTag = createNode(SyntaxKind.JSDocTypedefTag, atToken.pos)
          ...
          if (typeExpression) {
            if ((typeExpression.`type`.kind === SyntaxKind.JSDocTypeReference)) {
              val jsDocTypeReference =
                typeExpression.`type`.asInstanceOf[JSDocTypeReference]
            ...
            if ((!typedefTag.jsDocTypeLiteral)) {
              (typedefTag.jsDocTypeLiteral =
                typeExpression.`type`.asInstanceOf[JSDocTypeLiteral])
          ...
          def scanChildTags(): JSDocTypeLiteral = {
            val jsDocTypeLiteral =
              createNode(SyntaxKind.JSDocTypeLiteral, scanner.getStartPos())
                .asInstanceOf[JSDocTypeLiteral]
            ...
            while (((token() !== SyntaxKind.EndOfFileToken) && (!parentTagTerminated))) {
              {
                ...
                token() match {
                  case SyntaxKind.AtToken =>
                    if (canParseTag) {
                      (parentTagTerminated =
                        (!tryParseChildTag(jsDocTypeLiteral)))
          ...
          def parseJSDocTypeNameWithNamespace(flags: NodeFlags) = {
            ...
            if ((typeNameOrNamespaceName && parseOptional(
                  SyntaxKind.DotToken))) {
              val jsDocNamespaceNode =
                createNode(SyntaxKind.ModuleDeclaration, pos)
                  .asInstanceOf[JSDocNamespaceDeclaration]
        ...
        def tryParseChildTag(parentTag: JSDocTypeLiteral): Boolean = {
          Debug.assert((token() === SyntaxKind.AtToken))
          val atToken = createNode(SyntaxKind.AtToken, scanner.getStartPos())
            .asInstanceOf[AtToken]
          (atToken.end = scanner.getTextPos())
          nextJSDocToken()
          val tagName = parseJSDocIdentifierName()
              ...
              if (propertyTag) {
                if ((!parentTag.jsDocPropertyTags)) {
                  (parentTag.jsDocPropertyTags =
                    Array().asInstanceOf[NodeArray[JSDocPropertyTag]])
        ...
        def parseTemplateTag(atToken: AtToken,
          ...
          while (true) {
            {
              ...
              val typeParameter =
                createNode(SyntaxKind.TypeParameter, name.pos)
                  .asInstanceOf[TypeParameterDeclaration]
          ...
          val result = createNode(SyntaxKind.JSDocTemplateTag, atToken.pos)
            .asInstanceOf[JSDocTemplateTag]
          (result.atToken = atToken)
          (result.tagName = tagName)
        ...
        def createJSDocIdentifier(isIdentifier: Boolean): Identifier = {
          ...
          val result =
            createNode(SyntaxKind.Identifier, pos).asInstanceOf[Identifier]
  ...
  object IncrementalParser {
    def updateSourceFile(sourceFile: SourceFile,
      ...
      val incrementalSourceFile =
        sourceFile.asInstanceOf[Node].asInstanceOf[IncrementalNode]
      ...
      Debug.assert(
        (textSpanEnd(textChangeRangeNewSpan(changeRange)) === textSpanEnd(
          textChangeRangeNewSpan(textChangeRange))))
    ...
    def moveElementEntirelyPastChangeRange(element: IncrementalElement,
                                           isArray: Boolean,
                                           delta: Int,
                                           oldText: String,
                                           newText: String,
      ...
      def visitNode(node: IncrementalNode) = {
        ...
        if (node.jsDocComments) {
          (node.jsDocComments).foreach { fresh4 =>
            val jsDocComment = zeroOfMyType = fresh4 {
    ...
    def adjustIntersectingElement(element: IncrementalElement,
                                  changeStart: Int,
    ...
    def extendToAffectedRange(
        sourceFile: SourceFile,
        changeRange: TextChangeRange): TextChangeRange = {
      val maxLookahead = 1
      ...
      val finalSpan =
        createTextSpanFromBounds(start, textSpanEnd(changeRange.span))
      val finalLength = (changeRange.newLength + ((changeRange.span.start - start)))
      return createTextChangeRange(finalSpan, finalLength)

    }
    def findNearestNodeStartingBeforeOrAtPosition(sourceFile: SourceFile,
                                                  position: Int): Node = {
      var bestResult: Node = sourceFile
      var lastNodeEntirelyBeforePosition: Node = zeroOfMyType
      forEachChild(sourceFile, visit)
      if (lastNodeEntirelyBeforePosition) {
        val lastChildOfLastEntireNodeBeforePosition = getLastChild(
    ...
    def checkChangeRange(sourceFile: SourceFile,
                         newText: String,
                         textChangeRange: TextChangeRange,
                         aggressiveChecks: Boolean) = {
      val oldText = sourceFile.text
      if (textChangeRange) {
        ...
        if ((aggressiveChecks || Debug.shouldAssert(
          ...
          val oldTextSuffix = oldText
            .substring(textSpanEnd(textChangeRange.span), oldText.length)
          val newTextSuffix = newText.substring(
    ...
    trait IncrementalNodeArray
        extends NodeArray[IncrementalNode]
        with IncrementalElement {
      var length: Int
    }
    trait SyntaxCursor {
